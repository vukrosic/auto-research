# Mission — Golf Rope 5-Minute Micro Sprint R2

Human-set at `2026-03-25T15:49:55Z`.
...
- Use the corrected micro runtime path only.
- `WARMUP_STEPS=0`
- exactly one final validation pass
- capped validation sequences
- no quant roundtrip
- no export tail
- hard per-run process timeout

## Success Criteria

- Complete the micro baseline and the queued rope candidates.
